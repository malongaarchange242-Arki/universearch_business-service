...
const statsRoutes = async (app, _options) => {
    /**
     ...
     */
    app.get('/stats/organization/views-total', StatsController.getOrganizationViewsTotal);
    /**
     * GET /stats/organization/top-followers
     * Query params optionnels: organization_id, organization_type
     * Sinon le contexte est résolu via le Bearer token.
     */
    app.get('/stats/organization/top-followers', StatsController.getOrganizationTopFollowers);
};
